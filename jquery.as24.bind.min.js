(function(g){var k=g.attr;g.attr=function(a,c,b,d){var e=this,f=!a.nodeType;if(b===undefined)e=f?a[c]:k(a,c,b,d);else if(f){d=a[c];a[c]=b;g(a).trigger({type:"change."+c,attribute:c,newValue:b,oldValue:d});g(a).trigger({type:"change",attribute:c,newValue:b,oldValue:d})}else k(a,c,b,d);return e};getBindingType=function(a){a=g(a);if(a.length>0){a=a[0];switch(a.nodeName){case "INPUT":switch(a.type){case "hidden":case "password":return"text";case "reset":case "submit":return"button";default:return a.type}case "SELECT":return a.multiple?
"multiselect":"dropdown";case "BUTTON":return"button";case "TEXTAREA":return"text"}}return"property"};bindToView=function(a,c,b){b();g(a).bind("change."+c,b);return a};bindToProperty=function(a,c,b,d,e){return bindToView(a,c,function(){var f=g(a).attr(c);if(e!==undefined)f=e(f);var h=typeof b==="function"?b(f):g(b);switch(d){case undefined:case "val":h.val(f);break;case "text":h.text(f);break;default:h.attr(d,f)}})};bindToRadio=function(a,c,b,d){return bindToView(a,c,function(){var e=g(a).attr(c);
