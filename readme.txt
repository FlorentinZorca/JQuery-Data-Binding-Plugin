...
The tests folder contains the automatic tests/specs for the jquery.as24.bind.js and the required jasmine (https://github.com/pivotal/jasmine) library.
